  ...
  return (
    <div ref={wrapRef} className="relative">
      ...
      <button
        ...
        className="w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm text-left flex items-center justify-between outline-none focus:ring-2 focus:ring-slate-900/10 focus:border-slate-400 transition"
      >
...
export default function AdaptiveCoachingEngine() {
  ...
  const generateCoaching = () => {
    ...
    if (hunger === 'strong') tips.push('Add fiber + protein to your next meal.');
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="max-w-xl mx-auto lg:mx-0 text-center lg:text-left">
            ...
            <p className="mt-4 text-sm text-slate-500">
              Typical reply time: within 24 hours • Email: tanveerok355@gmail.com
            </p>
          </div>
